...
const experiences = [
  {
    ...
    en: {
      ...
      skills: [
        { id: 0, title: "Developed web applications using NextJS, TypeScript, and Tailwindcss..." },
        { id: 1, title: "Contributed significantly to projects for SolidSun and Sype.to..." },
        { id: 3, title: "Collaborated effectively with the team..." },
      ],
    },
    cs: {
      ...
      skills: [
        ...
        { id: 1, title: "Významný přínos k projektům pro SolidSun a Sype.to..." },
        { id: 3, title: "Efektivní spolupráce v týmu..." },
      ],
    },
  },
  {
    ...
    en: {
      ...
      position: "Frontend Web Apps Developer",
      skills: [
        { id: 0, title: "Built web applications using Next.js, TypeScript, Tailwind CSS..." },
        { id: 1, title: "Developed major components for Czechoslovak Group and Skladon..." },
        { id: 2, title: "Fostered team collaboration..." },
      ],
    },
    cs: {
      time: "2023 - 2024",
